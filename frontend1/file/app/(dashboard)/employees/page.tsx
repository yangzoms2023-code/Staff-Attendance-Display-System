  ...
  return (
    <div className="w-full min-w-0 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
        ...
        <Button 
          onClick={handleAdd} 
          className="gap-2 bg-[#0b2e4f] text-white shadow-sm h-10 px-5 shrink-0 self-start sm:self-
          auto border-2 border-transparent hover:bg-white hover:text-[#0b2e4f] hover:border-[#0b2e4f] 
          transition-colors"
        > 
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between gap-2">
              <div className="space-y-1 min-w-0">
                <p className="text-xs sm:text-sm font-medium text-slate-500 truncate">Total 
                  Employees</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{employees.length}</p>
              </div>
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-slate-100 flex items-center 
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-emerald-50 flex items-center 
              justify-center 
              shrink-0">
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-blue-50 flex items-center 
              justify-center shrink-
              0">
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-amber-50 flex items-center 
              justify-center shrink-0">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1 min-w-0">
              ...
              <Input
                ...
                className="pl-10 h-9 sm:h-10 border-slate-200 focus:border-slate-400 focus:ring-slate-
                400 w-full text-sm"
              />
            </div>
      ...
      <div className="w-full">
        {/* Table Header */}
        <div className="grid grid-cols-4 md:grid-cols-[100px_1fr_1.5fr_120px_120px_100px_100px] gap-0 
        border-b border-slate-200 bg-[#0B2E4F] rounded-t-lg text-white text-xs font-semibold 
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-7 w-7 rounded-md text-slate-400 hover:text-slate-600 hover:bg-
                      slate-100"
                    >
                  ...
                  <DropdownMenuContent align="end" className="min-w-[140px] p-1">
                    ...
                    <DropdownMenuItem
                      ...
                      focus:bg-red-50 focus:text-red-700 transition-colors"
                    >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[90vh] overflow-y-auto border-slate-
        200 p-4 sm:p-6">
                  ...
                  <SelectContent>
                    {DEPARTMENTS.map((dept) => (
                      <SelectItem 
                        key={dept} 
                        value={dept}
                        className="cursor-pointer hover:bg-[#0B2E4F] hover:text-white focus:bg-
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="border-slate-200 max-w-[90vw] sm:max-w-md p-4 sm:p-6">
          <DialogHeader>
            <DialogTitle className="text-base sm:text-lg font-semibold text-slate-900">Delete 
              Employee</DialogTitle>
            <DialogDescription className="text-xs sm:text-sm text-slate-500">
              Are you sure you want to delete <span className="font-semibold text-slate-900">
                {deletingEmployee?.name}</span>? 
          ...
          <DialogFooter className="gap-2 pt-2 flex-col sm:flex-row">
            <Button 
              ...
              className="h-9 sm:h-10 border-slate-200 text-slate-700 hover:bg-slate-50 w-full sm:w-
              auto"
            >
              Cancel
            </Button>
