...
import { Settings, User, Building2, Clock, AlertCircle, CheckCircle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      {message && (
        <div className={`flex items-center gap-2 rounded-lg p-4 ${
          message.type === "success" ? "bg-chart-1/10 text-chart-1" : "bg-destructive/10 text-destructive"
        }`}>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Define office working hours</CardDescription>
          </CardHeader>
          <CardContent>
            <FieldGroup>
              <div className="grid grid-cols-2 gap-4">
                <Field>
                  ...
                  <Input
                    ...
                    onChange={(e) => setOfficeSettings({ ...officeSettings, workStartTime: e.target.value })}
                  />
                </Field>
                <Field>
                  ...
                  <Input
                    ...
                    onChange={(e) => setOfficeSettings({ ...officeSettings, workEndTime: e.target.value })}
                  />
                </Field>
              </div>
              <Field>
                ...
                <Input
                  ...
                  onChange={(e) => setOfficeSettings({ ...officeSettings, lateThreshold: e.target.value })}
                />
