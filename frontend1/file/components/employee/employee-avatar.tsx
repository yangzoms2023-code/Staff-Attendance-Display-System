...
export function EmployeeAvatar({
	...
	if (photoPreview) {
		return (
			<div
				className={`${sizeClasses[size]} rounded-full overflow-hidden bg-slate-100 ${className}`}
			>
				<img
					src={photoPreview}
					alt={name}
	...
	return (
		<div
			className={`${sizeClasses[size]} rounded-full bg-gradient-to-br from-[#0B2E4F] to-[#1a5a92] flex items-center justify-center text-white font-bold ${className}`}
		>
